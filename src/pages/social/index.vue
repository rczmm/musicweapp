<template>
    <view class="social-view">
        ...
        <!-- 内容流区域 -->
        <scroll-view class="content-stream" scroll-y @scrolltolower="loadMoreContent" refresher-enabled
...
// 模拟获取内容数据
const fetchContent = (refresh = false) => {
...
const shareContent = (index) => {
  ...
  Taro.showShareMenu({
    ...
    showShareItems: ['wechat', 'wechatMoments']
  })
}
